...
function Dashboard() {
    ...
    const createBoard = async () => {
        ...
        try {
            ...
            setErrorMessage(
                "Could not create a new board. Please try again."
            );
        } finally {
            setIsCreating(false);
        }
    ...
    const deleteBoard = async (boardId) => {
        ...
        try {
            ...
            setBoards(
                boards.filter((board) => board._id !== boardId)
            );
        } catch (error) {
            setErrorMessage(
    ...
    const ownedBoards = boards.filter(
        (board) => board.owner._id === currentUser._id
    );
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="p-8 max-w-5xl mx-auto max-[767px]:p-4 max-[479px]:p-3">
                <div
                    className="
                ...
                {loading ? (
                    ...
                    <>
                        <section className="mb-10">
                            <h2 className="text-sm text-fog uppercase tracking-wide mb-3">
                                Created by you
                            </h2>
